#!/usr/bin/env python3
# backend/scripts/ingest_rozetka_knowledge.py
# Purpose: Ingest Rozetka marketplace knowledge into knowledge_chunks for RAG
# NOT for: Runtime — run once from dev machine

"""
Usage:
    cd listing_builder/backend
    python scripts/ingest_rozetka_knowledge.py           # ingest + embed
    python scripts/ingest_rozetka_knowledge.py --dry-run  # preview only
    python scripts/ingest_rozetka_knowledge.py --no-embed  # ingest without embeddings

Rozetka knowledge base files. ON CONFLICT DO NOTHING = safe to re-run.
"""
...
CHUNK_OVERLAP = 200
EMBED_BATCH = 5
SOURCE_TAG = "rozetka_knowledge"
SOURCE_TYPE = "rozetka_marketplace"
PREFIX = "Rozetka"
BASE_DIR = os.path.expanduser("~/Documents/RozetkaKnowledge")

# WHY: Map section headers to RAG categories for better retrieval
SECTION_CATEGORY = {
    "INFORMACJE OGÓLNE": "rozetka_general",
    "REJESTRACJA": "rozetka_general",
    "OPŁATY": "rozetka_fees",
    "PROWIZJE": "rozetka_fees",
    "TYTUŁ": "rozetka_listing",
    "OPIS": "rozetka_listing",
    "ZDJĘCIA": "rozetka_listing",
    "PARAMETRY": "rozetka_listing",
    "LISTING": "rozetka_listing",
    "PRODUKT": "rozetka_listing",
    "KATEGORI": "rozetka_categories",
    "DOSTAWA": "rozetka_delivery",
    "NOVA POSHTA": "rozetka_delivery",
    "MEEST": "rozetka_delivery",
    "UKRPOSHTA": "rozetka_delivery",
    "FULFILLMENT": "rozetka_delivery",
    "WYSYŁKA": "rozetka_delivery",
    "SEO": "rozetka_seo",
    "WIDOCZNOŚĆ": "rozetka_seo",
    "WYSZUKIWARK": "rozetka_seo",
    "MARKETING": "rozetka_marketing",
    "REKLAM": "rozetka_marketing",
    "PROMOCJ": "rozetka_marketing",
    "BŁĘDY": "rozetka_general",
    "API": "rozetka_api",
    "ZWROT": "rozetka_general",
    "REKLAMACJ": "rozetka_general",
    "PŁATNOŚ": "rozetka_general",
    "CROSS-BORDER": "rozetka_international",
    "UKRAIŃSKI": "rozetka_general",
}
...
def main():
    ...
    for file_idx, filename in enumerate(files):
        ...
        for chunk_idx, chunk in enumerate(chunks):
            ...
            chunk_with_context = f"[Rozetka Marketplace - {basename}]\n{chunk}"
