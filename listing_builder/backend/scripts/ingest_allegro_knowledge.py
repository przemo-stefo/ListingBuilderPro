#!/usr/bin/env python3
# backend/scripts/ingest_allegro_knowledge.py
# Purpose: Ingest Allegro marketplace knowledge into knowledge_chunks for RAG
# NOT for: Runtime — run once from dev machine

"""
Usage:
    cd listing_builder/backend
    python scripts/ingest_allegro_knowledge.py           # ingest + embed
    python scripts/ingest_allegro_knowledge.py --dry-run  # preview only
    python scripts/ingest_allegro_knowledge.py --no-embed  # ingest without embeddings

Allegro knowledge base files. ON CONFLICT DO NOTHING = safe to re-run.
"""
...
CHUNK_OVERLAP = 200
EMBED_BATCH = 5
SOURCE_TAG = "allegro_knowledge"
SOURCE_TYPE = "allegro_marketplace"
PREFIX = "Allegro"
BASE_DIR = os.path.expanduser("~/Documents/AllegroKnowledge")

# WHY: Map section headers to RAG categories for better retrieval
SECTION_CATEGORY = {
    "INFORMACJE OGÓLNE": "allegro_general",
    "REJESTRACJA": "allegro_general",
    "OPŁATY": "allegro_fees",
    "PROWIZJE": "allegro_fees",
    "CENNIK": "allegro_fees",
    "TYTUŁ": "allegro_listing",
    "OPIS": "allegro_listing",
    "ZDJĘCIA": "allegro_listing",
    "PARAMETRY": "allegro_listing",
    "LISTING": "allegro_listing",
    "OFERTA": "allegro_listing",
    "ALLEGRO ADS": "allegro_ads",
    "REKLAM": "allegro_ads",
    "KAMPANI": "allegro_ads",
    "CPC": "allegro_ads",
    "BUY BOX": "allegro_buybox",
    "KOSZYK": "allegro_buybox",
    "SMART": "allegro_smart",
    "DARMOWA DOSTAWA": "allegro_smart",
    "SUPER SPRZEDAWCA": "allegro_seller",
    "SPRZEDAWCA": "allegro_seller",
    "WYSYŁKA": "allegro_shipping",
    "DOSTAWA": "allegro_shipping",
    "FULFILLMENT": "allegro_shipping",
    "SEO": "allegro_seo",
    "WIDOCZNOŚĆ": "allegro_seo",
    "WYSZUKIWARK": "allegro_seo",
    "ALGORYTM": "allegro_seo",
    "KATEGORI": "allegro_categories",
    "EAN": "allegro_listing",
    "GTIN": "allegro_listing",
    "WARIANTY": "allegro_listing",
    "BŁĘDY": "allegro_general",
    "API": "allegro_api",
    "ALLEGRO.COM": "allegro_international",
    "CROSS-BORDER": "allegro_international",
    "PROTECT": "allegro_general",
    "ZWROT": "allegro_general",
    "REKLAMACJ": "allegro_general",
}
...
def main():
    ...
    for file_idx, filename in enumerate(files):
        ...
        for chunk_idx, chunk in enumerate(chunks):
            ...
            chunk_with_context = f"[Allegro Marketplace - {basename}]\n{chunk}"
