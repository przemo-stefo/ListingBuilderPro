// frontend/src/app/admin/components/CostsTab.tsx
// Purpose: API cost dashboard tab — extracted from admin/page.tsx
// NOT for: Overview or license management (those are separate tabs)
...
import { DollarSign, Zap, TrendingUp, BarChart3, Cpu } from 'lucide-react'
...
export function CostsTab() {
  ...
  if (isLoading) {
    return <div className="flex items-center justify-center py-12 text-gray-500">Ładowanie danych...</div>
  }
