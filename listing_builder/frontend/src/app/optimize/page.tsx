    ...
    <PremiumGate feature="Optymalizator">
      ...
      <FaqSection
        ...
        items={[
          ...
          { question: 'Ile kosztuje jedna optymalizacja?', answer: 'Plan darmowy: 3 optymalizacje dziennie (tylko Amazon). Plan Premium (19,00 PLN/mies): Optymalizator bez limitów na wszystkie marketplace, Import produktów, Konwerter ofert, Listing Score, Walidator Produktu i Ekspert Kaufland.' },
          ...
          { question: 'Co to jest "Model AI" w sekcji Cel i tryb?', answer: 'To silnik sztucznej inteligencji generujacy listing. Domyslnie uzywamy modelu Standardowego — jest darmowy i wliczony w cene. Jesli chcesz lepszej jakosci, mozesz wybrac Ultra lub Premium (wymagaja Twojego klucza API). Klucz zapisujesz w Ustawienia → Model AI.' },
          { question: 'Jaka jest roznica miedzy modelami AI?', answer: 'Standardowy: darmowy, dobra jakosc, najszybszy. Zaawansowany: najwyzsza jakosc, bez limitow. Turbo: szybki i precyzyjny (wymaga klucza). Ultra: najlepsza jakosc tekstu (wymaga klucza). Premium: wszechstronny (wymaga klucza). Jesli nie wiesz co wybrac — zostaw Standardowy, jest wystarczajaco dobry.' },
        ]}
      />
      </div>
    </PremiumGate>
